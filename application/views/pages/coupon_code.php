                                ...
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">
                                        <button class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                            data-target="#add-modal">Generate Coupon Code</button>
                                                 ...
                                                 <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>Demo</td>
                                                            <td><strong><span
                                                                        class="text-success">FIRST20</span></strong>
                                                            </td>
                                                            <td>26 June 2024 | 11:18 AM</td>
                                                            <td>29 June 2024 | 11:18 AM</td>
                                                            <td>30%</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>test</td>
                                                            <td><strong><span
                                                                        class="text-success">TEST20</span></strong>
                                                            </td>
                                                            <td>22 July 2024 | 11:18 AM</td>
                                                            <td>29 July 2024 | 11:18 AM</td>
                                                            <td>10%</td>
                                                            <td>
                                                                <input type="checkbox" checked data-toggle="toggle"
                                                                    data-on="Active" data-off="Deactive"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Generate Coupon
                                                        Code</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Coupon Start Date</label>
                                                    <input type="date" class="form-control" id="field-1"
                                                        placeholder="Enter Start Date" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Coupon End Date</label>
                                                    <input type="date" class="form-control" id="field-1"
