                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Manage Driver Charges</h3>
                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal">

                                        <div class="form-group row">
                                            <label class="control-label" for=""> Min Delivery Rate</label>
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-prepend">
                                                    <button type="button"
                                                        ...
                                                        <span>SAR</span> </button>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label" for=""> Per Km Charges</label>
                                            <div class="input-group">
