                    ...
                    <div class="row user-tabs">
                        <div class="col-md-12 col-xl-12">
                            <ul class="nav nav-tabs tabs-bordered nav-justified" role="tablist">
                                ...
                                <li class="nav-item tab">
                                    <a class="nav-link active" href="<?php echo base_url('driver_details_new_order') ?>"
                                ...
                                <li class="nav-item tab">
                                    <a class="nav-link" href="<?php echo base_url('driver_details_ongoing_order') ?>"
                                ...
                                <li class="nav-item tab">
                                    <a class="nav-link" href="<?php echo base_url('driver_details_completed_order') ?>"
                                ...
                                <li class="nav-item tab">
                                    <a class="nav-link" href="<?php echo base_url('driver_details_rating') ?>"
                                        aria-controls="rating" aria-selected="false">
                                        <span class="d-block d-sm-none"><i class="fa fa-cog"></i></span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content profile-tab-content">
                                ...
                                <div class="tab-pane show active" id="activities" aria-labelledby="activities-tab">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="text-center">Driver Rating <i class="fa fa-star"
                                            style="color: orange;"></i></h4>
                                    <hr>
                                    <div class="rat">
                                        <div class="side">
                                            <div>5 star</div>
                                        ...
                                        <div class="middle">
                                            <div class="bar-container">
                                                <div class="bar-5"
                                                    style="width: 10%;height: 8px;background-color: #04AA6D;"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="middle">
                                            <div class="bar-container">
                                                <div class="bar-4"
                                                    style="width: 20% ; height: 8px; background-color: #2196F3;"></div>
                                            </div>
                                        </div>
                                        <div class="side right">
                                            <div>15</div>
                                        ...
                                        <div class="middle">
                                            <div class="bar-container">
                                                <div class="bar-3"
                                                    style="width: 40% ; height: 8px; background-color: #00bcd4;"></div>
                                            </div>
                                        </div>
                                        <div class="side right">
                                            <div>7</div>
                                        ...
                                        <div class="middle">
                                            <div class="bar-container">
                                                <div class="bar-2"
                                                    style="width: 50% ; height: 8px; background-color: #ff9800;"></div>
                                            </div>
                                        </div>
                                        <div class="side right">
                                            <div>50</div>
                                        ...
                                        <div class="middle">
                                            <div class="bar-container">
                                                <div class="bar-1"
                                                    style="width: 5% ; height: 8px; background-color: #f44336;"></div>
                                            </div>
                                        </div>
                                        <div class="side right">
                                            <div>2</div>
