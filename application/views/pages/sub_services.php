                ...
                <div class="container-fluid">
                                ...
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">
                                        <button class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                                            data-target="#add-modal">Add Sub Service </button>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Select Main
                                                        service</label>
                                                    <select class="form-control">
                                                        <option>Select Main Service</option>

                                                        <option>Clothes & Blankets</option>
                                                        <option>Carpet & Furniture</option>
                                                        <option>Shoes & Bags</option>
                                                        <option>House Cleaning </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Select
                                                        service</label>
                                                    <select class="form-control">
                                                        ...
                                                        <option>Blanket & Linen </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Sub Service </label>
                                                    <input type="text" class="form-control" id="field-1"
                                                        placeholder="Enter sub Service " required>
                                                </div>
                    ...
                    <div id="edit-modal" class="modal fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Update Sub Service </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control">
                                                        ...
                                                        <option selected>Clothes & Blankets</option>
                                                        <option>Carpet & Furniture</option>
                                                        <option>Shoes & Bags</option>
                                                        <option>House Cleaning </option>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Sub Service </label>
                                                    <input type="text" class="form-control" id="field-1" value=" Shirt"
                                                        required>
                                                </div>
                                            </div>
