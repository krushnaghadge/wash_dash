                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                <ul class="nav nav-tabs tabs-bordered nav-justified" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-b2-tab" data-toggle="tab" href="#home-b2"
                                            ...
                                            <span class="d-none d-sm-block">Customer Message</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-b2-tab" data-toggle="tab" href="#profile-b2"
                                            ...
                                            <span class="d-none d-sm-block">Vendor Message</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="message-b2-tab" data-toggle="tab" href="#message-b2"
                                            ...
                                            <span class="d-none d-sm-block">Driver Message</span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td> <a class="btn btn-secondary btn-sm"
                                                                                    ...
                                                                                    <i
                                                                                        class="fa fa-envelope text-light"></i>
                                                                                </a></td>

                                                                            <td>

                                                                                <a href="#"
                                                                                    class="btn btn-danger btn-sm sa-warning">
                                    ...
                                    <div id="vendor-modal" class="modal fade " tabindex="-1" role="dialog"
                                        aria-labelledby="myModalLabel" aria-modal="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Vendor Message</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                    ...
                                    <div id="driver-modal" class="modal fade " tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Driver Message</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
