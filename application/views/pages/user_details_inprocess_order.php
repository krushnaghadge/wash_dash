                        ...
                        <div class="row user-tabs">
                            <div class="col-md-12 col-xl-12">
                                <ul class="nav nav-tabs tabs-bordered " role="tablist">
                                    ...
                                    <li class="nav-item tab">
                                        <a class="nav-link active" href="<?php echo base_url('user_details_inprocess_order') ?>" role="tab" aria-controls="projects" aria-selected="false">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content profile-tab-content">
                                    <div class="tab-pane show active" id="projects" aria-labelledby="projects-tab">
                                                            ...
                                                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="text-warning">In-process</span>
                                                                        </td>
