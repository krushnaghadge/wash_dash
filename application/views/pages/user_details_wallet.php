                    ...
                    <div class="wraper">
                        ...
                        <div class="row user-tabs">
                            <div class="col-md-12 col-xl-12">
                                <ul class="nav nav-tabs tabs-bordered " role="tablist">
                                    ...
                                    <li class="nav-item tab">
                                        <a class="nav-link" href="<?php echo base_url('user_details_ready_deliver') ?>" role="tab" aria-controls="setting" aria-selected="false">
                                    ...
                                    <li class="nav-item tab">
                                        <a class="nav-link active" href="<?php echo base_url('user_details_wallet') ?>" role="tab" aria-controls="wallet" aria-selected="false">
                                            <span class="d-block d-sm-none"><i class="fa fa-cog"></i></span>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="tab-pane show active" id="wallet" aria-labelledby="wallet-tab">
                                                        ...
                                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><strong><span class="text-success">Credited</span></strong>
                                                                    </td>
                                                                    <td><strong><span class="text-success">SAR
                                                                                20</span></strong>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><strong><span class="text-danger">Debited</span></strong>
                                                                    </td>
                                                                    <td><strong><span class="text-danger">SAR
                                                                                20</span></strong>
                                                                    </td>
