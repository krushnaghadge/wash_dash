                            ...
                            <div class="card">
                                <div class="">
                                    <ul class="nav nav-tabs tabs-bordered" role="tablist">
                                        <li class="nav-item tab">
                                            <a class="nav-link" href="<?php echo base_url('vendor_details') ?>">
                                                <span class="d-block d-sm-none"><i class="fa fa-home"></i></span>
                                                <span class="d-none d-sm-block">Current order</span>
                                            </a>
                                        </li>
                                        <!-- <li class="nav-item tab">
                                            <a class="nav-link" href="<?php echo base_url('user_cancelled_order') ?>">
                                                <span class="d-block d-sm-none"><i class="fa fa-user"></i></span>
                                                <span class="d-none d-sm-block">Cancel order</span>
                                            </a>
                                        </li> -->
                                        <li class="nav-item tab">
                                            <a class="nav-link active" href="<?php echo base_url('user_completed_order') ?>">
                                                <span class="d-block d-sm-none"><i class="fa fa-user"></i></span>
                                ...
                                <div class="card-body">
                                    <div class="tab-content profile-tab-content">
                                        <div class="tab-pane show active" id="completed" aria-labelledby="activities-tab">
                                            <div class="row">
                                                <div class="col-12">
