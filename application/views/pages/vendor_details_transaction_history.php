                        ...
                        <div class="row user-tabs">
                            <div class="col-md-12 col-xl-12">
                                <ul class="nav nav-tabs tabs-bordered " role="tablist">
                                    ...
                                    <li class="nav-item tab">
                                        <a href="<?php echo base_url('vendor_details_transaction_history') ?>" class="nav-link active" role="tab" aria-controls="transaction" aria-selected="false">
                                            <span class="d-block d-sm-none"><i class="fa fa-cog"></i></span>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content profile-tab-content">
                                    ...
                                    <div class="tab-pane show active" id="transaction" aria-labelledby="complete-tab">
