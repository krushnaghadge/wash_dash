! function (o) {
    ...
    t.prototype.initTooltipPlugin = function () {
        ...
        o.fn.slimScroll && o(".slimscroll").slimScroll({
            height: "auto",
            position: "right",
            size: "5px",
            touchScrollStep: 20,
        ...
        o('[data-plugin="custommodal"]').on("click", function (t) {
            t.preventDefault(), new Custombox.modal({
                ...
                overlay: {
                    color: o(this).attr("data-overlayColor")
                }
            }).open()
        })
    }, t.prototype.initCounterUp = function () {
        o(this).attr("data-delay") && o(this).attr("data-delay"), o(this).attr("data-time") && o(this).attr("data-time");
    ...
    function (t) {
        "use strict";
        var e = function () {
            this.$body = t("body"), this.$fullscreenBtn = t("#btn-fullscreen")
        };
        e.prototype.launchFullscreen = function (t) {
            t.requestFullscreen ? t.requestFullscreen() : t.mozRequestFullScreen ? t.mozRequestFullScreen() : t.webkitRequestFullscreen ? t.webkitRequestFullscreen() : t.msRequestFullscreen && t.msRequestFullscreen()
        }, e.prototype.exitFullscreen = function () {
            document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen()
        }, e.prototype.toggle_fullscreen = function () {
            ...
            var t = this;
            t.$fullscreenBtn.on("click", function () {
                t.toggle_fullscreen()
            })
        }, t.FullScreen = new e, t.FullScreen.Constructor = e
    }(window.jQuery),
    function (i) {
        "use strict";
        var t = function () {
        ...
        t.prototype._resetSidebarScroll = function () {
            ...
            var e = this;
            this.initLayout(), i.Portlet.init(), this.initMenu(), i.Components.init(), i.RightSidebar.init(), i.FullScreen.init(), e.$window.on("resize", function (t) {
